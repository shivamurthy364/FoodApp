...
public class Upload_Receipe extends AppCompatActivity {
    ...
    public void btnUploadRecepie(View view) {
    ...
    public void uploadRecepie()
    {
        ...
        FirebaseDatabase.getInstance().getReference("Recepie")
                .child(myCurrentDateTime).setValue(foodData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                {
                    Toast.makeText(Upload_Receipe.this, "Recipe Uploaded", Toast.LENGTH_SHORT).show();
